  ...
  <VControl>
    <VDropdown title="With unicons" spaced>
      <template #content>
        <a href="#" class="dropdown-item is-media">
          <div class="icon">
            <iconify-icon class="iconify" icon="uil:pagelines"/>
          </div>
          <div class="meta">
            <span>Invest</span>
            <span>Buy more stocks</span>
        ...
        <a href="#" class="dropdown-item is-media is-active">
          <div class="icon">
            <iconify-icon class="iconify" icon="uil:meeting-board"/>
          </div>
          <div class="meta">
            <span>Compare</span>
            <span>Compare with others</span>
        ...
        <a href="#" class="dropdown-item is-media">
          <div class="icon">
            <iconify-icon class="iconify" icon="uil:social-distancing"/>
          </div>
          <div class="meta">
            <span>Trade</span>
            <span>View opportunities</span>
        ...
        <a href="#" class="dropdown-item is-media">
          <div class="icon">
            <iconify-icon class="iconify" icon="uil:palette"/>
          </div>
          <div class="meta">
            <span>Wallet</span>
            <span>Open stock wallet</span>
