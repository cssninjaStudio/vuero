...
<div class="buttons">
    <V-Button color="primary" outlined>
        Button
    </V-Button>
    <V-Button color="info" outlined>
        Button
    </V-Button>
    <V-Button color="success" outlined>
        Button
    </V-Button>
    <V-Button color="warning" outlined>
        Button
    </V-Button>
    <V-Button color="danger" outlined>
        Button
    </V-Button>
</div>
