...
Tabs can be displayed in an old school boxed layout. To display boxed tabs, use the `is-boxed` class on the main `tabs` element. check the markup for more details.
