...
<div class="buttons">
  <a class="button v-button is-primary is-raised" @click="clickMe">Primary</a>
  <a class="button v-button is-info is-raised" @click="clickMe">Info</a>
  <a class="button v-button is-success is-raised" @click="clickMe">Success</a>
  <a class="button v-button is-warning is-elevated" @click="clickMe">Warning</a>
  <a class="button v-button is-danger is-elevated" @click="clickMe">Danger</a>
</div>
