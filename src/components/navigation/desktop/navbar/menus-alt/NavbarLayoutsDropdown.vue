          ...
          <div id="lists-menu" class="columns is-gapless mega-menus is-active">
            ...
            <div class="column is-4">
              <div class="dropdown-item-group">
                ...
                <div class="column-content" data-simplebar>
                  ...
                  <RouterLink
                    :to="{ name: 'webapp-layouts-list-view-2' }"
                    class="dropdown-item is-media"
                  >
                    <div class="icon">
                      <i class="lnil lnil-list-alt"></i>
                  ...
                  <RouterLink
                    :to="{ name: 'webapp-layouts-list-view-3' }"
                    class="dropdown-item is-media"
                  >
                    <div class="icon">
                      <i class="lnil lnil-list-alt"></i>
                  ...
                  <RouterLink
                    :to="{ name: 'webapp-layouts-list-view-4' }"
                    class="dropdown-item is-media"
                  >
                    <div class="icon">
            ...
            <div class="column is-4">
              <div class="dropdown-item-group">
                ...
                <div class="column-content" data-simplebar>
                  <RouterLink
                    :to="{ name: 'webapp-layouts-list-flex-2' }"
                    class="dropdown-item is-media"
                  >
                    <div class="icon">
                      <i class="lnil lnil-list-alt-1"></i>
                  ...
                  <RouterLink
                    :to="{ name: 'webapp-layouts-list-flex-3' }"
                    class="dropdown-item is-media"
                  >
                    <div class="icon">
                      <i class="lnil lnil-list-alt-1"></i>
          ...
          <div id="grids-menu" class="columns is-gapless mega-menus">
            ...
            <div class="column is-4">
              <div class="dropdown-item-group">
                ...
                <div class="column-content">
                  <RouterLink
                    :to="{ name: 'webapp-layouts-grid-cards-1' }"
                    class="dropdown-item is-media"
                  >
                    <div class="icon">
                      <i class="lnil lnil-grid-alt"></i>
                  ...
                  <RouterLink
                    :to="{ name: 'webapp-layouts-grid-cards-2' }"
                    class="dropdown-item is-media"
                  >
                    <div class="icon">
                      <i class="lnil lnil-grid-alt"></i>
                  ...
                  <RouterLink
                    :to="{ name: 'webapp-layouts-grid-cards-3' }"
                    class="dropdown-item is-media"
                  >
                    <div class="icon">
                      <i class="lnil lnil-grid-alt"></i>
                  ...
                  <RouterLink
                    :to="{ name: 'webapp-layouts-grid-cards-4' }"
                    class="dropdown-item is-media"
                  >
                    <div class="icon">
                      <i class="lnil lnil-grid-alt"></i>
            ...
            <div class="column is-4">
              <div class="dropdown-item-group">
                ...
                <div class="column-content">
                  <RouterLink
                    :to="{ name: 'webapp-layouts-grid-tiles-1' }"
                    class="dropdown-item is-media"
                  >
                    <div class="icon">
                  ...
                  <RouterLink
                    :to="{ name: 'webapp-layouts-grid-tiles-2' }"
                    class="dropdown-item is-media"
                  >
                    <div class="icon">
                      <i class="lnil lnil-layout-alt-2"></i>
                  ...
                  <RouterLink
                    :to="{ name: 'webapp-layouts-grid-tiles-3' }"
                    class="dropdown-item is-media"
                  >
                    <div class="icon">
                      <i class="lnil lnil-layout-alt-2"></i>
            ...
            <div class="column is-4">
              <div class="dropdown-item-group">
                ...
                <div class="column-content">
                  <RouterLink
                    :to="{ name: 'webapp-layouts-grid-users-1' }"
                    class="dropdown-item is-media"
                  >
                    <div class="icon">
                  ...
                  <RouterLink
                    :to="{ name: 'webapp-layouts-grid-users-2' }"
                    class="dropdown-item is-media"
                  >
                    <div class="icon">
                      <i class="lnil lnil-users-alt"></i>
                  ...
                  <RouterLink
                    :to="{ name: 'webapp-layouts-grid-users-3' }"
                    class="dropdown-item is-media"
                  >
                    <div class="icon">
                      <i class="lnil lnil-users-alt"></i>
                  ...
                  <RouterLink
                    :to="{ name: 'webapp-layouts-grid-users-4' }"
                    class="dropdown-item is-media"
                  >
                    <div class="icon">
                      <i class="lnil lnil-users-alt"></i>
          ...
          <div id="pages-menu" class="columns is-gapless mega-menus">
            ...
            <div class="column is-4">
              <div class="dropdown-item-group">
                ...
                <div class="column-content" data-simplebar>
                  <RouterLink
                    :to="{ name: 'webapp-layouts-profile-view' }"
                    class="dropdown-item is-media"
                  >
                    <div class="icon">
            ...
            <div class="column is-4">
              <div class="dropdown-item-group">
                ...
                <div class="column-content" data-simplebar>
                  ...
                  <RouterLink
                    :to="{ name: 'webapp-layouts-search-results' }"
                    class="dropdown-item is-media"
                  >
                    <div class="icon">
                  ...
                  <RouterLink
                    :to="{ name: 'webapp-layouts-search-empty' }"
                    class="dropdown-item is-media"
                  >
                    <div class="icon">
                      <i class="lnil lnil-search-alt"></i>
            ...
            <div class="column is-4">
              <div class="dropdown-item-group">
                ...
                <div class="column-content" data-simplebar>
                  ...
                  <RouterLink
                    :to="{ name: 'webapp-layouts-kanban-board' }"
                    class="dropdown-item is-media"
                  >
                    <div class="icon">
                      <i class="lnil lnil-layout-alt-1"></i>
          ...
          <div id="subpages-menu" class="columns is-gapless mega-menus">
            ...
            <div class="column is-4">
              <div class="dropdown-item-group">
                ...
                <div class="column-content" data-simplebar>
                  <RouterLink
                    :to="{ name: 'webapp-layouts-saas-billing' }"
                    class="dropdown-item is-media"
                  >
                    <div class="icon">
                  ...
                  <RouterLink
                    :to="{ name: 'webapp-layouts-action-page-1' }"
                    class="dropdown-item is-media"
                  >
                    <div class="icon">
                  ...
                  <RouterLink
                    :to="{ name: 'webapp-layouts-action-page-2' }"
                    class="dropdown-item is-media"
                  >
                    <div class="icon">
                      <i class="lnil lnil-thunderbolt"></i>
