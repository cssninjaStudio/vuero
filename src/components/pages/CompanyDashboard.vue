        ...
        <div class="dashboard-card is-tickets">
          ...
          <div class="ticket-list">
            ...
            <div class="media-flex is-responsive-mobile is-dark-bordered-12">
              ...
              <div class="flex-meta">
                <span>[#45651] Cannot save changes to user profile</span>
                <span
                  >Iam not able to save changes I make to my user profile. When
                  I click on the save button, it simply says "failed".</span
                >
            ...
            <div class="media-flex is-responsive-mobile is-dark-bordered-12">
              ...
              <div class="flex-meta">
                ...
                <span
                  >when I try to create a new opportunity, Iam redirected to a
                  404 page after clicking the action button.</span
                >
            ...
            <div class="media-flex is-responsive-mobile is-dark-bordered-12">
              ...
              <div class="flex-meta">
                ...
                <span
                  >When I try to use PayPal as a payment method, it spins
                  forever and I get an error message after that.</span
                >
            ...
            <div class="media-flex is-responsive-mobile is-dark-bordered-12">
              ...
              <div class="flex-meta">
                <span>[#45862] Cannot find the assets in the theme folder</span>
                <span
                  >I followed the documentation but Iam not able to locate the
                  assets in the main folder. Can I get some help?</span
                >
