...
const WizardV1Step3 = defineComponent({
  name: 'WizardV1Step3',
  components: {},
  setup() {
    // WizardV1Step3 - Composition API

    return {}
  },
})

export default WizardV1Step3
</script>
...
<template>
  <div class="step-content">
    ...
    <div class="page-placeholder is-files">
      <div class="placeholder-content">
        <img
          ...
          src="/src/assets/images/illustrations/wizard/upload-placeholder.svg"
          alt=""
        />
        <img
        ...
        <a class="action-link toggle-uploader-link">Add Files</a>
      </div>
    </div>
    ...
    <div class="uploader is-hidden">
      ...
      <div id="previews" class="template-list">
