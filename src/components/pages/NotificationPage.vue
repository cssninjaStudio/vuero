              ...
              <div class="box-text">
                <div class="meta-text">
                  <p>
                    ...
                    <a>Task</a> from
                    <small class="tag is-rounded is-purple">Pending</small>
                    to
                    <small class="tag is-rounded is-green">Completed</small>
                  </p>
                  <span>9:18 am</span>
                </div>
              </div>
              ...
              <div class="box-text">
                <div class="meta-text">
                  <p>
                    ...
                    <a>Task</a> from
                    <small class="tag is-rounded is-danger">Overdue</small>
                    to
                    <small class="tag is-rounded is-green">Completed</small>
                  </p>
                  <span>9:18 am</span>
