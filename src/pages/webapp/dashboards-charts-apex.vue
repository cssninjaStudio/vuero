...
for (var i = 0; i < 12; i++) {
  ts1 = ts1 + 86400000
  let innerArr: any[] = [ts1, dataSeries[2][i].value]
  dataSet[0].push(innerArr)
}
for (var i = 0; i < 18; i++) {
  ts2 = ts2 + 86400000
  let innerArr: any[] = [ts2, dataSeries[1][i].value]
  dataSet[1].push(innerArr)
}
for (var i = 0; i < 12; i++) {
  ts3 = ts3 + 86400000
  let innerArr: any[] = [ts3, dataSeries[0][i].value]
...
useTitle('Dashboards Charts Apex - WebApp - Vuero')
</script>
    ...
    >
      <div class="page-content-wrapper">
        <div class="page-content is-relative">
          ...
          <div class="page-content-inner apex-dashboard p-t-30">
