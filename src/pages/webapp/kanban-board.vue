...
useTitle('Kanban Board - WebApp - Vuero')
</script>
    ...
    >
      <div class="page-content-wrapper">
        <div class="page-content kanban-content is-relative">
          <div class="page-title is-webapp">
          ...
          <div class="kanban-toolbar is-webapp">
          ...
          <div class="columns is-kanban-wrapper">
            ...
            <div class="column is-one-fifth">
              ...
              <div class="kanban-column">
                ...
                <div id="demo-invite" class="kanban-card is-new">
                  <div class="card-body">
                    <h4 class="card-title">
                      Create prototype with JWT authentication
                    </h4>
                  ...
                  <footer class="card-footer">
                    ...
                    <a class="card-footer-item">Approve</a>
                  </footer>
                </div>

                <div class="kanban-card is-new">
                  <div class="card-body">
                    <h4 class="card-title">
                      Design a todo list component using React
                    </h4>
                    <div class="new-avatar">
              ...
              <div class="kanban-column">
                ...
                <div id="kanban-1">
                  ...
                  <div class="kanban-card">
                    <div class="card-body">
                      <h4 class="card-title">
                        Implement new footer in all pages
                      </h4>
                      <div class="kanban-card-stats">
                        <span>
                          <Icon icon="feather:clock" />
            ...
            <div class="column is-one-fifth">
              <div class="kanban-column">
                ...
                <div class="collapsed-content">
                  ...
                  <div class="collapsed-text">In Test</div>
                </div>
                <!-- Expanded content -->
                <div class="column-title">
                  <input
                ...
                <div id="kanban-2">
                  <div class="kanban-card">
                    <div class="card-body">
                      <h4 class="card-title">
                        Implement the projects REST API
                      </h4>
                      <div class="kanban-card-stats">
                        <span>
                          <Icon icon="feather:clock" />
            ...
            <div class="column is-one-fifth">
              <div class="kanban-column is-empty">
                <!-- Collapsed content -->
                <div class="collapsed-content">
                  <div class="expand-button">
                    <Icon icon="feather:plus" />
