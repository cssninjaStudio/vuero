...
useTitle('Dashboards Business 1 - WebApp - Vuero')
</script>
      ...
      <div class="page-content-wrapper">
        <div class="page-content is-relative">
          ...
          <div class="page-content-inner">
            ...
            <div
              class="business-dashboard flights-dashboard has-webapp-spacing"
            >
              <div class="columns m-t-20">
                ...
                <div class="column is-3">
                  <!--Widget-->
                  <div class="widget search-widget is-straight">
                    <div class="field">
                      <div class="control">
                        <input
                          type="text"
                  ...
                  <div class="filters-card">
                    <a
                      class="button h-button is-primary is-fullwidth is-bold is-raised"
                      >Add To Favorites</a
                    >
