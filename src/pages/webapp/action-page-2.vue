...
useTitle('Action Page 2 - WebApp - Vuero')
</script>
                    ...
                    <div class="box-content">
                      ...
                      <h3 class="dark-inverted">
                        ...
                        <span class="is-dark-primary"
                          >Banking Solution Website</span
                        >
                        project.
                      </h3>
                      <div
                        class="sender-message is-dark-card-bordered is-dark-bg-4"
                      >
                        <h4 class="dark-inverted">Message from Jason</h4>
                        <p>
                          Hey Erik, It would be really cool if you could give us
                          a hand on this project. There are a lot of tasks
                          popping out every day and I feel the team is getting a
                          bit overwhelmed. We'd love to have you board.
                        </p>
                      </div>
                    ...
                    <div class="action-list">
                      ...
                      <div class="media-flex">
                        ...
                        <div class="flex-meta">
                          <span>UI Review</span>
                          <p>
                            Please review the latest wireframs the team has
                            provided.
                          </p>
                        </div>
                      </div>
