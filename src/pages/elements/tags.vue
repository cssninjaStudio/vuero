        ...
        <div class="column is-12">
          ...
          <div class="demo-card">
            <div class="demo-title">
              ...
              <p>
                Vuero offers a tag component than can be customized to fit any
                needs. Tags can have multiple colors. Available modifier classes
                are <code>is-primary</code>, <code>is-info</code>,
                <code>is-success</code>, <code>is-warning</code>,
                <code>is-danger</code>, <code>is-light</code>,
                <code>is-white</code>, <code>is-solid</code>.
              </p>
              <a
                class="code-trigger"
          ...
          <div class="demo-card">
            <div class="demo-title">
              ...
              <p>
                ...
                <code>tag</code> element to apply a rounded style. See the code
          ...
          <div class="demo-card">
            <div class="demo-title">
              ...
              <p>
                ...
                <code>tag</code> element to apply an outlined style. See the
            ...
            <div class="card-inner">
              <div class="tags">
                <span class="tag is-rounded is-primary is-outlined"
                  >Primary</span
                >
                <span class="tag is-rounded is-info is-outlined">Info</span>
                <span class="tag is-rounded is-success is-outlined"
                  >Success</span
                >
                <span class="tag is-rounded is-warning is-outlined"
                  >Warning</span
                >
          ...
          <div class="demo-card">
            <div class="demo-title">
              ...
              <p>
                ...
                <code>tag</code> element to apply an light style. See the code
                examples for more details about usage.
              </p>
              <a
                class="code-trigger"
          ...
          <div class="demo-card">
            <div class="demo-title">
              ...
              <p>
                ...
                <code>tag</code> element to apply an elevated style. See the
                code examples for more details about usage.
              </p>
              <a
                class="code-trigger"
            ...
            <div class="card-inner">
              <div class="tags">
                ...
                <span class="tag is-rounded is-primary is-elevated"
                  >Primary</span
                >
                <span class="tag is-rounded is-info is-elevated">Info</span>
                <span class="tag is-rounded is-success is-elevated"
                  >Success</span
                >
                <span class="tag is-rounded is-warning is-elevated"
                  >Warning</span
                >
          ...
          <div class="demo-card">
            <div class="demo-title">
              ...
              <p>
                Vuero tags can be merged into a single one to achieve addon
                styles. You can attach another tag or a delete button if you
                need to. See the code example for more details about usage.
              </p>
              <a
                class="code-trigger"
          ...
          <div class="demo-card">
            <div class="demo-title">
              ...
              <p>
                Vuero tag adons can be organized in an inline tag list. You can
                use it to build a custom tag input for example. See the code
                examples for more details about usage.
              </p>
              <a
                class="code-trigger"
