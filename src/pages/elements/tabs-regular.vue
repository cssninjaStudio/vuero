        ...
        <div class="column is-12">
          ...
          <div class="demo-card">
            <div class="demo-title">
              ...
              <p>
                Vuero provides styled navigation tabs that you can use to build
                nice looking and optimized layouts. Tabs work with a javascript
                implementation. Check the markup for more details.
              </p>
              <a
                class="code-trigger"
              ...
              >
                <Icon v-show="displayCode1" icon="feather:code" class="open" />
                <Icon v-show="!displayCode1" icon="feather:x" class="close" />
              </a>
            </div>
          ...
          <div class="demo-card">
            <div class="demo-title">
              ...
              <p>
                ...
                <code>is-centered</code> class to center align the tabs. Check
                ...
                <div class="tabs-inner">
                  <div class="tabs is-centered">
                    <ul>
                      ...
                      <li :class="[activeTab1 === 'projects' && 'is-active']">
                        <a @click="activeTab1 = 'projects'">Projects</a>
                      </li>
                      <li :class="[activeTab1 === 'tasks' && 'is-active']">
...
&#x3C;/div&#x3E;
          ...
          <div class="demo-card">
            <div class="demo-title">
              ...
              <p>
                Vuero provides styled navigation tabs that you can use to build
                nice looking and optimized layouts. Use the
                <code>is-right</code> class to center align the tabs on the
                right. Tabs work with a javascript implementation. Check the
                ...
                <div class="tabs-inner">
                  <div class="tabs is-right">
                    <ul>
                      ...
                      <li :class="[activeTab2 === 'projects' && 'is-active']">
                        <a @click="activeTab2 = 'projects'">Projects</a>
                      </li>
                      <li :class="[activeTab2 === 'tasks' && 'is-active']">
...
&#x3C;/div&#x3E;
          ...
          <div class="demo-card">
            <div class="demo-title">
              ...
              <p>
                You can easily embed <code>Feather Icons</code> in your tab
                elements. The styling is already taken care of, just add the
                icons you want. Check the markup for more details.
              </p>
              <a class="code-trigger">
                <i class="iconify open" data-icon="feather:code"></i>
                <i class="iconify close" data-icon="feather:x"></i>
                ...
                <div class="tabs-inner">
                  <div class="tabs">
                    <ul>
                      ...
                      <li :class="[activeTab3 === 'projects' && 'is-active']">
                        <a @click="activeTab3 = 'projects'">
                          <i class="iconify" data-icon="feather:box"></i>
                          <span>Projects</span>
                        </a>
                      </li>
                      <li :class="[activeTab3 === 'tasks' && 'is-active']">
...
&#x3C;/div&#x3E;
          ...
          <div class="demo-card">
            <div class="demo-title">
              ...
              <p>
                You can easily embed <code>Font Awesome 5</code> in your tab
                elements. The styling is already taken care of, just add the
                icons you want. Check the markup for more details.
              </p>
              <a class="code-trigger">
                ...
                <div class="tabs-inner">
                  <div class="tabs">
                    <ul>
                      ...
                      <li :class="[activeTab4 === 'projects' && 'is-active']">
                        <a @click="activeTab4 = 'projects'">
                          <i class="fas fa-umbrella"></i>
                          <span>Projects</span>
                        </a>
                      </li>
                      <li :class="[activeTab4 === 'tasks' && 'is-active']">
...
&#x3C;/div&#x3E;
          ...
          <div class="demo-card">
            <div class="demo-title">
              ...
              <p>
                You can easily embed <code>Line Icons</code> in your tab
                elements. The styling is already taken care of, just add the
                icons you want. Check the markup for more details.
              </p>
              <a class="code-trigger">
                ...
                <div class="tabs-inner">
                  <div class="tabs">
                    <ul>
                      ...
                      <li :class="[activeTab5 === 'projects' && 'is-active']">
                        <a @click="activeTab5 = 'projects'">
                          <i class="lnil lnil-analytics-alt-1"></i>
                          <span>Projects</span>
                        </a>
                      </li>
                      <li :class="[activeTab5 === 'tasks' && 'is-active']">
...
&#x3C;/div&#x3E;
          ...
          <div class="demo-card">
            <div class="demo-title">
              <h3 class="title is-thin is-5">Boxed Tabs</h3>
              <p>
                Tabs can be displayed in an old school boxed layout. To display
                boxed tabs, use the <code>is-boxed</code> class on the main
                <code>tabs</code> element. check the markup for more details.
              </p>
              <a class="code-trigger">
                <i class="iconify open" data-icon="feather:code"></i>
                <i class="iconify close" data-icon="feather:x"></i>
                ...
                <div class="tabs-inner">
                  <div class="tabs is-boxed">
                    <ul>
                      ...
                      <li :class="[activeTab6 === 'projects' && 'is-active']">
                        <a @click="activeTab6 = 'projects'">Projects</a>
                      </li>
                      <li :class="[activeTab6 === 'tasks' && 'is-active']">
...
&#x3C;/div&#x3E;
          ...
          <div class="demo-card">
            <div class="demo-title">
              <h3 class="title is-thin is-5">Toggle Tabs</h3>
              <p>
                Tabs can be displayed in exclusive toggle layout. To display
                toggle tabs, use the <code>is-toggle</code> class on the main
                <code>tabs</code> element. check the markup for more details.
              </p>
              <a class="code-trigger">
                <i class="iconify open" data-icon="feather:code"></i>
                ...
                <div class="tabs-inner">
                  <div class="tabs is-toggle">
                    <ul>
                      ...
                      <li :class="[activeTab7 === 'projects' && 'is-active']">
                        <a @click="activeTab7 = 'projects'">Projects</a>
                      </li>
                      <li :class="[activeTab7 === 'tasks' && 'is-active']">
...
&#x3C;/div&#x3E;
          ...
          <div class="demo-card">
            <div class="demo-title">
              <h3 class="title is-thin is-5">Rounded Toggle Tabs</h3>
              <p>
                Tabs can be displayed in exclusive toggle layout. To display
                rounded toggle tabs, use the
                <code>is-toggle</code> and
                <code>is-toggle-rounded</code> classes on the main
                <code>tabs</code> element. check the markup for more details.
              </p>
              <a class="code-trigger">
                <i class="iconify open" data-icon="feather:code"></i>
                ...
                <div class="tabs-inner">
                  <div class="tabs is-toggle is-toggle-rounded">
                    <ul>
                      ...
                      <li :class="[activeTab8 === 'projects' && 'is-active']">
                        <a @click="activeTab8 = 'projects'">Projects</a>
                      </li>
                      <li :class="[activeTab8 === 'tasks' && 'is-active']">
