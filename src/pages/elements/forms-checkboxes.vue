...
useHead({
  title: 'Elements - Forms Checkboxes - Vuero',
})
</script>
...
&#x3C;/div&#x3E;
          ...
          <div class="demo-card">
            <div class="demo-title">
              ...
              <p>
                Vuero checkboxes can be circles instead of squares. Simply add
                the <code>is-circle</code> modifier class to your
                <code>checkbox</code> element. See the code example for more
                details about usage.
              </p>
              <a class="code-trigger">
                <i class="iconify open" data-icon="feather:code"></i>
