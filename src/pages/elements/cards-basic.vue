...
useHead({
  title: 'Elements - Cards Basics - Vuero',
})
</script>
  ...
  <div>
    <div class="page-title has-text-centered">
      ...
      <div class="title-wrap">
        <h1 class="title is-4">Basic Cards</h1>
      </div>
    ...
    <div class="page-content-inner">
      ...
      <div class="columns is-multiline">
        <div class="column is-12">
          <!--Basic Cards-->
          <div class="demo-card is-narrow">
            <div class="demo-title">
              <h3 class="title is-thin is-5">Basic Cards</h3>
              <p>
                Vuero cards are very versatile and can be used in any type of
                layout. Vuero provides 3 main basic cards with the following
                classes: <code>.s-card</code>, <code>.r-card</code> and
                <code>.l-card</code>. The main difference each one of those is
                the border radius, giving a unique look and feel to each one of
                them. If you explore Vuero SCSS code, you will notice that they
                serve as a base for numerous components, using the SCSS
      ...
      <div class="columns is-multiline">
        <div class="column is-12">
          <!--Elevated Cards-->
          <div class="demo-card is-narrow has-margin-top">
            <div class="demo-title">
              <h3 class="title is-thin is-5">Elevated Cards</h3>
              <p>
                Vuero cards can be elevated and show a slight box shadow. To
      ...
      <div class="columns is-multiline">
        <div class="column is-4">
          <div class="s-card is-raised demo-s-card">
            <h3 class="title is-5">Raised S-Card</h3>
            <p>
              I can be used as is in any layout. S Cards are simple containers
              that can hold any type of content, from simple plain text to more
              structured markup.
        ...
        <div class="column is-4">
          <div class="r-card is-raised demo-r-card">
            <h3 class="title is-5">Raised R-Card</h3>
            <p>
              I can be used as is in any layout. R Cards are simple containers
              that can hold any type of content, from simple plain text to more
              structured markup.
        ...
        <div class="column is-4">
          <div class="l-card is-raised demo-l-card">
            <h3 class="title is-5">Raised L-Card</h3>
            <p>
              I can be used as is in any layout. L Cards are simple containers
              that can hold any type of content, from simple plain text to more
              structured markup.
      ...
      <div class="columns is-multiline">
        <div class="column is-4">
          <div class="s-card is-primary demo-s-card">
            <h3 class="title is-5">Primary S-Card</h3>
            <p>
              I can be used as is in any layout. S Cards are simple containers
              that can hold any type of content, from simple plain text to more
              structured markup.
        ...
        <div class="column is-4">
          <div class="r-card is-secondary demo-r-card">
            <h3 class="title is-5">Secondary R-Card</h3>
            <p>
              I can be used as is in any layout. R Cards are simple containers
              that can hold any type of content, from simple plain text to more
              structured markup.
        ...
        <div class="column is-4">
          <div class="l-card is-info demo-l-card">
            <h3 class="title is-5">Info L-Card</h3>
            <p>
              I can be used as is in any layout. L Cards are simple containers
              that can hold any type of content, from simple plain text to more
              structured markup.
        ...
        <div class="column is-4">
          <div class="s-card is-success demo-s-card">
            <h3 class="title is-5">Success S-Card</h3>
            <p>
              I can be used as is in any layout. S Cards are simple containers
              that can hold any type of content, from simple plain text to more
              structured markup.
        ...
        <div class="column is-4">
          <div class="r-card is-warning demo-r-card">
            <h3 class="title is-5">Warning R-Card</h3>
            <p>
              I can be used as is in any layout. R Cards are simple containers
              that can hold any type of content, from simple plain text to more
              structured markup.
        ...
        <div class="column is-4">
          <div class="l-card is-danger demo-l-card">
            <h3 class="title is-5">Danger L-Card</h3>
            <p>
              I can be used as is in any layout. L Cards are simple containers
              that can hold any type of content, from simple plain text to more
              structured markup.
        ...
        <div class="column is-12">
          ...
          <div class="demo-card is-narrow has-margin-top">
            <div class="demo-title">
              ...
              <p>
                Vuero cards can have a small flex header where you can put come
                content. Reference the markup for more details about usage.
              </p>
            </div>
          </div>
        </div>
