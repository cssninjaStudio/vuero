        ...
        <div class="column is-12">
          ...
          <div class="demo-card">
            <div class="demo-title">
              <h3 class="title is-thin is-5">Unordered Lists</h3>
              <p>
                By default, using an unordered <code>ul</code> list won't
                generate an html list. This is part of the Bulma specification.
                To generate you unordered list, wrap it inside a
                <code>div</code> with the <code>content</code> class. Lists can
                also have the <code>is-light</code> modifier to change the text
                color.
              </p>
              <a
                class="code-trigger"
          ...
          <div class="demo-card">
            <div class="demo-title">
              <h3 class="title is-thin is-5">Ordered Lists</h3>
              <p>
                Ordered lists <code>ol</code> are also genrated using a
                <code>div</code> with the <code>content</code> class. Ordered
                list bullets can be controlled with the
                <code>type</code> attribute. Available types are
                <code>type="1"</code>, <code>type="A"</code>,
          ...
          <div class="demo-card">
            <div class="demo-title">
              ...
              <p>
                To create a title, you can add the
                <code>title</code> class to any html element. Title sizes can be
                controlled with numbered modifiers using the patter
                <code>is-*</code> where <code>*</code> represents a number
                between 3 and 6. Titles can also be thinner using the
                <code>is-thin</code>, bold using the <code>is-bold</code> or
                bolder using the <code>is-bolder</code> modifier classes.
              </p>
              <a
                class="code-trigger"
          ...
          <div class="demo-card">
            <div class="demo-title">
              <h3 class="title is-thin is-5">Subtitle</h3>
              <p>
                To create a subtitle, you can add the
                <code>subtitle</code> class to any html element. Subtitle sizes
                can be controlled with numbered modifiers using the patter
                <code>is-*</code> where <code>*</code> represents a number
                between 4 and 6.
              </p>
              <a
          ...
          <div class="demo-card">
            <div class="demo-title">
              ...
              <p>
                Vuero provides <code>blockquote</code> html element styling.
                Wrap your <code>blockquote</code> element inside a
                <code>div</code> with the <code>content</code> class.
                Blockquotes can have different colors. Available color modifier
                classes are <code>is-primary</code>, <code>is-success</code>,
          ...
          <div class="demo-card">
            <div class="demo-title">
              ...
              <p>
                Vuero provides dividers for your textual content. You can use
                horizontal and vertical dividers by passing the divider text as
                a <code>data-content</code> html attribute. See the code example
          ...
          <div class="demo-card">
            <div class="demo-title">
              <h3 class="title is-thin is-5">Content Table</h3>
              <p>
                You can also use the <code>content</code> class to wrap an html
                <code>table</code>
                element to apply minimum styles to your table UI. Please refer
                to the Vuero components section to find more advanced table
