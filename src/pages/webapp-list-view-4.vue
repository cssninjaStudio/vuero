                ...
                <div class="list-view-inner">
                  ...
                  <div class="list-view-item">
                    <div class="list-view-item-inner">
                      <div class="pre-meta">
                        <h3 data-filter-match>Strawberry & Cream Cake</h3>
                      </div>
                      <img
                        class="avatar"
                        src="https://via.placeholder.com/150x150"
                        data-demo-src="/@images/illustrations/list-views/cake-1.svg"
                        alt=""
                      />
                      <div class="meta-left">
                      ...
                      <div class="meta-right">
                        ...
                        <div class="buttons">
                          <a
                            class="button h-button is-primary is-outlined is-raised"
                            >View Recipe</a
                          >
                          <button
                  ...
                  <div class="list-view-item">
                    <div class="list-view-item-inner">
                      <div class="pre-meta">
                        <h3 data-filter-match>Orange & Lemon Cake</h3>
                      </div>
                      <img
                        class="avatar"
                        src="https://via.placeholder.com/150x150"
                        data-demo-src="/@images/illustrations/list-views/cake-2.svg"
                        alt=""
                      />
                      <div class="meta-left">
                        <h3 data-filter-match>
                  ...
                  <div class="list-view-item">
                    <div class="list-view-item-inner">
                      <div class="pre-meta">
                        <h3 data-filter-match>Three Chocolates Cake</h3>
                      </div>
                      <img
                        class="avatar"
                        src="https://via.placeholder.com/150x150"
                        data-demo-src="/@images/illustrations/list-views/cake-3.svg"
                        alt=""
                      />
                      <div class="meta-left">
                        <h3 data-filter-match>
                  ...
                  <div class="list-view-item">
                    <div class="list-view-item-inner">
                      <div class="pre-meta">
                        <h3 data-filter-match>Wedding Cake</h3>
                      </div>
                      <img
                        class="avatar"
                        src="https://via.placeholder.com/150x150"
                        data-demo-src="/@images/illustrations/list-views/cake-4.svg"
                        alt=""
                      />
                      <div class="meta-left">
                        <h3 data-filter-match>
                  ...
                  <div class="list-view-item">
                    <div class="list-view-item-inner">
                      <div class="pre-meta">
                        <h3 data-filter-match>Vanilla Waffles</h3>
                      </div>
                      <img
                        class="avatar"
                        src="https://via.placeholder.com/150x150"
                        data-demo-src="/@images/illustrations/list-views/cake-5.svg"
                        alt=""
                  ...
                  <div class="list-view-item">
                    <div class="list-view-item-inner">
                      <div class="pre-meta">
                        <h3 data-filter-match>Strawberry Slice</h3>
                      </div>
                      <img
                        class="avatar"
                        src="https://via.placeholder.com/150x150"
                        data-demo-src="/@images/illustrations/list-views/cake-6.svg"
                        alt=""
                      />
                      <div class="meta-left">
                        <h3 data-filter-match>
                  ...
                  <div class="list-view-item">
                    <div class="list-view-item-inner">
                      <div class="pre-meta">
                        <h3 data-filter-match>Marmelade Donuts</h3>
                      </div>
                      <img
                        class="avatar"
                        src="https://via.placeholder.com/150x150"
                        data-demo-src="/@images/illustrations/list-views/cake-7.svg"
                        alt=""
                      />
                      <div class="meta-left">
                        <h3 data-filter-match>
                  ...
                  <div class="list-view-item">
                    <div class="list-view-item-inner">
                      <div class="pre-meta">
                        <h3 data-filter-match>Peanut Butter Sandwich</h3>
                      </div>
                      <img
                        class="avatar"
                        src="https://via.placeholder.com/150x150"
                        data-demo-src="/@images/illustrations/list-views/cake-8.svg"
                        alt=""
                      />
                      <div class="meta-left">
                        <h3 data-filter-match>
                  ...
                  <div class="list-view-item">
                    <div class="list-view-item-inner">
                      <div class="pre-meta">
                        <h3 data-filter-match>Peanut Butter Slice</h3>
                      </div>
                      <img
                        class="avatar"
                        src="https://via.placeholder.com/150x150"
                        data-demo-src="/@images/illustrations/list-views/cake-9.svg"
                        alt=""
                      />
                      <div class="meta-left">
                        <h3 data-filter-match>
                  ...
                  <div class="list-view-item">
                    <div class="list-view-item-inner">
                      <div class="pre-meta">
                        <h3 data-filter-match>Strawberry Spicy</h3>
                      </div>
                      <img
                        class="avatar"
                        src="https://via.placeholder.com/150x150"
                        data-demo-src="/@images/illustrations/list-views/cake-10.svg"
                        alt=""
                      />
                      <div class="meta-left">
                        <h3 data-filter-match>
                ...
                <div class="list-view-inner">
                  ...
                  >
                    <div class="placeholder-content">
                      ...
                      <p class="is-larger">
                        Looks like you don't have any saved recipes for the
                        moment. Start by exploring the latest ones and add your
                        favorites to the saved recipes section.
                      </p>
                    </div>
                  </div>
                </div>
