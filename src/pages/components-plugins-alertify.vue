...
useTitle('Components - Plugins Alertify - Vuero')
</script>
              ...
              <div class="column is-12">
                ...
                <div class="demo-card">
                  <div class="demo-title">
                    ...
                    <p>
                      If a user needs to confirm an action before it is
                      executed, you should use a confirm prompt. For more
                      information about usage and available options, please
                      refer to the
