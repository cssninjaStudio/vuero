      ...
      <div class="page-content-wrapper">
        <div class="page-content is-relative">
          ...
          <div class="page-content-inner">
            ...
            <div
              class="lifestyle-dashboard lifestyle-dashboard-v2 has-webapp-spacing"
            >
              ...
              <div class="columns">
                          ...
                          <a class="media-flex-center">
                            <div class="h-avatar">
                              <img
                                ...
                                src="https://via.placeholder.com/150x150"
                                data-demo-src="/@images/photo/demo/dashboards/lifestyle/1.jpg"
                                alt=""
                              />
                            </div>
                            <div class="flex-meta">
                              <span>Extreme Foot Trekk</span>
                          ...
                          <a class="media-flex-center">
                            <div class="h-avatar">
                              <img
                                class="avatar is-squared"
                                src="https://via.placeholder.com/150x150"
                                data-demo-src="/@images/photo/demo/dashboards/lifestyle/2.jpg"
                                alt=""
                              />
                            </div>
                            <div class="flex-meta">
                              <span>Rafting trip</span>
                          ...
                          <a class="media-flex-center">
                            <div class="h-avatar">
                              <img
                                class="avatar is-squared"
                                src="https://via.placeholder.com/150x150"
                                data-demo-src="/@images/photo/demo/dashboards/lifestyle/3.jpg"
                                alt=""
                              />
                            </div>
                            <div class="flex-meta">
                              <span>Climbing Group [Pro]</span>
                              <span>Oct 31, 2020</span>
                            </div>
                            <div class="flex-end">
                              <div class="rating">
                          ...
                          <a class="media-flex-center">
                            <div class="h-avatar">
                              <img
                                class="avatar is-squared"
                                src="https://via.placeholder.com/150x150"
                                data-demo-src="/@images/photo/demo/dashboards/lifestyle/4.jpg"
                                alt=""
                              />
                            </div>
                            <div class="flex-meta">
                              <span>Bicycle Madness Trek</span>
                              <span>Oct 31, 2020</span>
                            </div>
                            <div class="flex-end">
                              <div class="rating">
                          ...
                          <a class="media-flex-center">
                            <div class="h-avatar">
                              <img
                                class="avatar is-squared"
                                src="https://via.placeholder.com/150x150"
                                data-demo-src="/@images/photo/demo/dashboards/lifestyle/5.jpg"
                                alt=""
                              />
                            </div>
                            <div class="flex-meta">
                              <span>Extreme Triathlon</span>
                          ...
                          <a class="media-flex-center">
                            <div class="h-avatar">
                              <img
                                class="avatar is-squared"
                                src="https://via.placeholder.com/150x150"
                                data-demo-src="/@images/photo/demo/dashboards/lifestyle/6.jpg"
                                alt=""
                              />
                            </div>
                            <div class="flex-meta">
                          ...
                          <a class="media-flex-center">
                            <div class="h-avatar">
                              <img
                                class="avatar is-squared"
                                src="https://via.placeholder.com/150x150"
                                data-demo-src="/@images/photo/demo/dashboards/lifestyle/7.jpg"
                                alt=""
                              />
                            </div>
                            <div class="flex-meta">
                              <span>Suit Diving</span>
                          ...
                          <a class="media-flex-center">
                            <div class="h-avatar">
                              <img
                                class="avatar is-squared"
                                src="https://via.placeholder.com/150x150"
                                data-demo-src="/@images/photo/demo/dashboards/lifestyle/8.jpg"
                                alt=""
                              />
                            </div>
                            <div class="flex-meta">
                              <span>Desert Trekk</span>
                ...
                <div class="column is-3">
                  ...
                  <div class="widget text-widget">
                    ...
                    <div class="widget-content">
                      <p>
                        ...
                        <span>10 unread messages</span> in your inbox. It could
                        be a good time to check them out.
                      </p>
                    </div>
                  </div>
                  ...
                  <!--Widget-->
                  <div
                    class="list-widget list-widget-v1 p-t-20 p-l-20 p-r-20 p-b-20"
                  >
                    <div class="widget-head">
                      <h3 class="dark-inverted">Hot Topics</h3>
                      <WidgetDropdown />
                    </div>
                    ...
                    <div class="inner-list">
                      ...
                      <div class="inner-list-item media-flex-center">
                        ...
                        <div class="flex-meta is-light">
                          <a href="#">Biking</a>
                          <span>12.2K talk about this</span>
                        </div>
                      </div>
                      <!--List Item-->
                      <div class="inner-list-item media-flex-center">
                        ...
                        <div class="flex-meta is-light">
                          <a href="#">Running</a>
                          <span>76.4K talk about this</span>
                        </div>
                      </div>
                      <!--List Item-->
                      <div class="inner-list-item media-flex-center">
                        ...
                        <div class="flex-meta is-light">
                          <a href="#">Skiing</a>
                          <span>8.6K talk about this</span>
                        </div>
                      </div>
                      <!--List Item-->
                      <div class="inner-list-item media-flex-center">
                        ...
                        <div class="flex-meta is-light">
                          <a href="#">Swimming</a>
                          <span>6.9K talk about this</span>
                        </div>
                      </div>
                      <!--List Item-->
                      <div class="inner-list-item media-flex-center">
                        ...
                        <div class="flex-meta is-light">
                          <a href="#">Workout</a>
                          <span>154.8K talk about this</span>
                        </div>
                      </div>
                    </div>
                  </div>
