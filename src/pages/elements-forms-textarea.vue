              ...
              <div class="column is-12">
                ...
                <div class="demo-card">
                  <div class="demo-title">
                    <h3 class="title is-thin is-5">Textarea</h3>
                    <p>
                      A standard Html5 text box to use in your applications. You
                      can control the box text length with the
                      <code>rows="*"</code> attribute. Like other form controls,
...
&#x3C;/div&#x3E;
                ...
                <div class="demo-card">
                  <div class="demo-title">
                    ...
                    <p>
                      Like other form controls, textareas can have different
                      border colors when focused. You simply have to add one of
                      the following modifiers to the
...
&#x3C;/div&#x3E;
                ...
                <div class="demo-card">
                  <div class="demo-title">
                    ...
                    <p>
                      A textarea can be shown in a loading state. For that, you
                      need to wrap it inside a <code>control</code> element.
                      Then, simply add the <code>is-loading</code> class to the
                      wrapping <code>control</code> element. Please refer to the
...
&#x3C;/div&#x3E;
                ...
                <div class="demo-card">
                  <div class="demo-title">
                    <h3 class="title is-thin is-5">Disabled State</h3>
                    <p>
                      A textarea can be shown in a disabled state. For that, you
                      need to wrap it inside a <code>control</code> element.
                      Simply add the <code>disabled</code> attribute to the
...
&#x3C;/div&#x3E;
                ...
                <div class="demo-card">
                  <div class="demo-title">
                    <h3 class="title is-thin is-5">Textarea Addon</h3>
                    <p>
                      Textareas that are wrapped by a <code>control</code> and a
                      <code>field</code> can have a single bottom addon. You can
                      use it to display a toolbar or any type of user actions.
