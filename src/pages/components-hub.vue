              ...
              <div class="column is-12">
                <div class="hub-wrapper">
                  <div class="hub-header has-text-centered">
                    ...
                    <p class="light-text">
                      This is the Huro components library with detailed code
                      examples.
                    </p>
                  </div>
                      ...
                      <div class="hub-card">
                        <div class="hub-card-body">
                          <div class="inner-content">
                            ...
                            <p class="light-text">
                              Get familiar with the Huro avatar styles. Code
                              examples included.
                            </p>
                          </div>
                          <img
                      ...
                      <div class="hub-card">
                        <div class="hub-card-body">
                          <div class="inner-content">
                            ...
                            <p class="light-text">
                              Get familiar with the Huro accordion styles. Code
                              examples included.
                            </p>
                          </div>
                          <img
                      ...
                      <div class="hub-card">
                        <div class="hub-card-body">
                          <div class="inner-content">
                            ...
                            <p class="light-text">
                              Get familiar with the Huro breadcrumb styles. Code
                              examples included.
                            </p>
                          </div>
                          <img
                      ...
                      <div class="hub-card">
                        <div class="hub-card-body">
                          <div class="inner-content">
                            ...
                            <p class="light-text">
                              Get familiar with the Huro dropdown styles. Code
                              examples included.
                            </p>
                          </div>
                          <img
                      ...
                      <div class="hub-card">
                        <div class="hub-card-body">
                          <div class="inner-content">
                            ...
                            <p class="light-text">
                              Get familiar with the Huro icon boxes styles. Code
                              examples included.
                            </p>
                          </div>
                          <img
                      ...
                      <div class="hub-card">
                        <div class="hub-card-body">
                          <div class="inner-content">
                            ...
                            <p class="light-text">
                              Get familiar with the Huro messages styles. Code
                              examples included.
                            </p>
                          </div>
                          <img
                      ...
                      <div class="hub-card">
                        <div class="hub-card-body">
                          <div class="inner-content">
                            ...
                            <p class="light-text">
                              Get familiar with the Huro modal styles. Code
                              examples included.
                            </p>
                          </div>
                          <img
                      ...
                      <div class="hub-card">
                        <div class="hub-card-body">
                          <div class="inner-content">
                            ...
                            <p class="light-text">
                              Get familiar with the Huro progress bar styles.
                      ...
                      <div class="hub-card">
                        <div class="hub-card-body">
                          <div class="inner-content">
                            ...
                            <p class="light-text">
                              Get familiar with the Huro nav tabs styles. Code
                              examples included.
                            </p>
                          </div>
                          <img
                      ...
                      <div class="hub-card">
                        <div class="hub-card-body">
                          <div class="inner-content">
                            ...
                            <p class="light-text">
                              Get familiar with the Huro flex table styles. Code
                              examples included.
                            </p>
                          </div>
                          <img
                      ...
                      <div class="hub-card">
                        <div class="hub-card-body">
                          <div class="inner-content">
                            ...
                            <p class="light-text">
                              Get familiar with the Huro snacks styles. Code
                              examples included.
                            </p>
                          </div>
                          <img
                      ...
                      <div class="hub-card">
                        <div class="hub-card-body">
                          <div class="inner-content">
                            ...
                            <p class="light-text">
                              Get familiar with the Huro plugins. Code examples
                              included.
                            </p>
                          </div>
                          <img
