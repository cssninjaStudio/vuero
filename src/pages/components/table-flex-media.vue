...
useHead({
  title: 'Components - Table Flex Media - Vuero',
})
</script>
  ...
  <div>
    <div class="page-title has-text-centered">
      ...
      <div class="title-wrap">
        <h1 class="title is-4">Media Table</h1>
      </div>
        ...
        <div class="column is-12">
          ...
          <div class="demo-card has-more-margin">
            <div class="demo-title">
              ...
              <p>
                ...
                the flexbox technology and is fully responsive. Check the markup
                for more details.
              </p>
            </div>
          </div>
          ...
          <div class="flex-table">
            ...
            <div class="flex-table-item">
              ...
              <div class="flex-table-cell" data-th="Location">
                <span class="light-text">Los Angeles, CA</span>
              </div>
              <div class="flex-table-cell" data-th="Industry">
            ...
            <div class="flex-table-item">
              <div class="flex-table-cell is-media is-grow" data-th="User">
                ...
                <div>
                  <span class="item-name">Tina C.</span>
                  <span class="item-meta">
