...
useHead({
  title: 'Components - Plugins Lightgallery - Vuero',
})
</script>
  ...
  <div>
    <div class="page-title has-text-centered">
      ...
      <div class="title-wrap">
        <h1 class="title is-4">Light Gallery</h1>
      </div>
        ...
        <div class="column is-12">
          ...
          <div class="demo-card">
            <div class="demo-title">
              <h3 class="title is-thin is-5">Light Gallery</h3>
              <p>
                ...
                shows you how it works with images.
              </p>
      ...
      <div id="lightgallery" class="light-gallery-wrap">
        ...
        >
          <img
            ...
            alt=""
            @error="$event.target.src = 'https://via.placeholder.com/1600x900'"
          />
        </a>
        <a
          href="https://via.placeholder.com/1600x900"
