          ...
          <div class="demo-card">
            <div class="demo-title">
              ...
              <p>
                ...
                <code>type="datetime"</code> attribute on the input. Please
          ...
          <div class="demo-card">
            <div class="demo-title">
              ...
              <p>
                ...
                <code>type="date"</code> attribute on the input. Also use the
                <code>displayMode: 'dialog'</code> option in the javascript code
                for it to display as a modal. Please reference the plugin
                <a href="https://creativebulma.net/product/calendar/demo"
                  >documentation</a
                >
                for more details about usage.
          ...
          <div class="demo-card">
            <div class="demo-title">
              ...
              <p>
                ...
                <code>type="date"</code> attribute on the input. Also use the
                <code>displayMode: 'inline'</code> option in the javascript code
                for it to display inline. Please reference the plugin
                <a href="https://creativebulma.net/product/calendar/demo"
                  >documentation</a
                >
                for more details about usage.
          ...
          <div class="demo-card">
            <div class="demo-title">
              ...
              <p>
                ...
                documentation on
                <a href="https://github.com/Pikaday/Pikaday">Github</a>. You can
