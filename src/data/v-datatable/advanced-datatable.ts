...
function renderYesNo(data: any, cell: any, row: any) {
  return data == 'true'
    ? '<div class="has-text-centered"><span class="positive-icon"><i class="iconify" data-icon="feather:check"></i></span></div>'
    : '<div class="has-text-centered"><span class="negative-icon"><i class="iconify" data-icon="feather:x"></i></span></div>'
}
...
function renderProfit(data: any, cell: any, row: any) {
  if (data > 0) {
    return `<div class="has-text-centered"><span class="positive-icon light-text"><i class="iconify" data-icon="feather:trending-up"></i> +${data}%</span></div>`
  } else if (data < 0) {
    return `<div class="has-text-centered"><span class="negative-icon is-danger light-text"><i class="iconify" data-icon="feather:trending-down"></i> -${data}%</span></div>`
  }
}
